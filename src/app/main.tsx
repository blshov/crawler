      ...
      {isGameDone && (
        <div className="top-0 left-0 flex absolute w-full h-full animate-opacity-slow items-center justify-center overflow-hidden">
          ...
          <div className="flex flex-col gap-6 absolute items-center justify-center">
            ...
            <div className="font-medium  gap-4 px-8 py-4 flex drop-shadow-[0_1.2px_1.2px_rgba(255,255,255,0.2)] flex-col animate-spin-show w-[22rem] lg:w-[27rem] h-full bg-gradient-45 from-[#070921] to-[#20235B] rounded-md items-center justify-center ">
